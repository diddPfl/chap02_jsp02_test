<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <!--
    	...
    	- 객체로 생성한 자바 빈즈는 request, session, application 영역에 저장하여 다른 페이지들과 공유할 수 있다.
    	- id="member": 자바빈즈를 만드는데 그 이를을 member라고 하겠다.
    	- class="자바빈즈로 만들어질 도메인 클래스의 풀 경로"
    	- scope="request": 자바빈즈를 생성해서 request 영역에 보관하겠다.
    -->
